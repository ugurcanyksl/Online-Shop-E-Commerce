...
namespace OnlineShopEcommerce.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult>Create(ApplicationUser user)
        {
            if(ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    TempData["save"] = "Kullanıcı başarıyla oluşturuldu";
        ...
        public async Task<IActionResult>Edit(ApplicationUser user)
        {
            ...
            if (result.Succeeded)
            {
                TempData["save"] = "Kullanıcı başarıyla güncellendi";
                return RedirectToAction(nameof(Index));
            }
        ...
        public async Task<IActionResult>Locout(ApplicationUser user)
        {
            ...
            if(rowAffected>0)
            {
                TempData["save"] = "Kullanıcı başarıyla kilitlendi";
                return RedirectToAction(nameof(Index));
            }
            return View(userInfo);
        }
        ...
        public async Task<IActionResult> Active(ApplicationUser user)
        {
            ...
            if (rowAffected > 0)
            {
                TempData["save"] = "Kullanıcı başarıyla etkinleştirildi";
                return RedirectToAction(nameof(Index));
            }
            return View(userInfo);
        }
        ...
        public async Task<IActionResult> Delete(ApplicationUser user)
        {
            ...
            if (rowAffected > 0)
            {
                TempData["save"] = "Kullanıcı başarıyla silindi";
                return RedirectToAction(nameof(Index));
            }
            return View(userInfo);
        }
