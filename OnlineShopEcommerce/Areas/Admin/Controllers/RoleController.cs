...
using OnlineShopEcommerce.Areas.Admin.Models;
...
namespace OnlineShopEcommerce.Areas.Admin.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public async Task<IActionResult>Create(string name)
        {
            ...
            if(result.Succeeded)
            {
                TempData["save"] = "Rol başarıyla kaydedildi";
        ...
        public async Task<IActionResult> Edit(string id,string name)
        {
            ...
            if (result.Succeeded)
            {
                TempData["save"] = "Rol başarıyla güncellendi";
                return RedirectToAction(nameof(Index));
            }
            return View();
        }
        ...
        public async Task<IActionResult>DeleteConfirm(string id)
        {
            ...
            if(result.Succeeded)
            {
                TempData["delete"] = "Rol başarıyla silindi";
                return RedirectToAction(nameof(Index));
            }            
            return View();
        }
        ...
        public async Task<IActionResult> Assign(RoleUserVm roleUser)
        {
            ...
            {
                ViewBag.mgs = "Bu kullanıcı bu rolü zaten atadı.";
                ViewData["UserId"] = new SelectList(_db.ApplicationUsers.Where(f => f.LockoutEnd < DateTime.Now || f.LockoutEnd == null).ToList(), "Id", "UserName");
                ViewData["RoleId"] = new SelectList(_roleManager.Roles.ToList(), "Name", "Name");
                return View();
            }
            ...
            if(role.Succeeded)
            {
                TempData["save"] = "Kullanıcı Rolü atandı.";
                return RedirectToAction(nameof(Index));
            }
            return View();
        }
